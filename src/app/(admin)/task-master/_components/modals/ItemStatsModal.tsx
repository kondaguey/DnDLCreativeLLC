...
export default function ItemStatsModal({ isOpen, onClose, item, onUpdateMetadata }: ItemStatsModalProps) {
    ...
    const stats = useMemo(() => {
        if (!item) return { streak: 0, missed: 0 };
                            ...
                            <div className="w-full h-8 sm:h-12 mb-2 z-10">
                                <ResponsiveContainer width="100%" height="100%">
                                    <AreaChart data={trendData}>
                                        <defs>
                                            <linearGradient id="gTrendStats" x1="0" y1="0" x2="0" y2="1">
                                                <stop offset="5%" stopColor="#10b981" stopOpacity={0.3} />
                                                <stop offset="95%" stopColor="#10b981" stopOpacity={0} />
                                            </linearGradient>
                                        </defs>
                                        <Area type="monotone" dataKey="value" stroke="#10b981" strokeWidth={2} fillOpacity={1} fill="url(#gTrendStats)" />
                                    </AreaChart>
                                </ResponsiveContainer>
                            </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3 mt-4 sm:mt-0">
                                                    <button
                                                        ...
                                                        className="px-3 py-1.5 text-[10px] sm:text-[11px] font-black uppercase tracking-widest text-slate-500 hover:text-rose-400 hover:bg-rose-500/10 rounded-xl transition-all bg-white/5 border border-white/5 hover:border-rose-500/20 active:scale-95 flex items-center gap-1.5"
                                                    >
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-3 mt-4 sm:mt-0">
                                                <button
                                                    ...
                                                    className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 text-slate-500 hover:text-white hover:bg-white/10 border border-white/5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all"
                                                    title="Ignore this missed entry"
                                                >
                ...
                <div className="p-6 sm:p-8 border-t border-white/5 bg-[#0a0f18]/90 backdrop-blur-xl flex flex-col sm:flex-row items-center justify-between gap-4 shrink-0">
                    <div className="flex items-center gap-4 sm:gap-5 self-start">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[8px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-slate-600">Plan Horizon</span>
                    ...
                    <div className="flex items-center gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-purple-500/10 border border-purple-400/20 rounded-xl sm:rounded-[20px] text-purple-400 text-[10px] sm:text-sm font-black uppercase tracking-[0.15em] shadow-lg w-full sm:w-auto justify-center">
                        <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-purple-400 animate-pulse shadow-[0_0_8px_rgba(168,85,247,0.5)]" />
                        Cycle: {recurrence}
                    </div>
                </div>
            </div>
